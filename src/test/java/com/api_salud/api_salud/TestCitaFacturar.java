...
public class TestCitaFacturar {
	...
	@Test
	void contextLoads() {
		CitaFacturacionRequest c = new CitaFacturacionRequest();
...
//		 c.setIdAtencion(0);
		 c.setIdServicio(0);
		 c.setIdProgramacion(0);
		 c.setFechaSolicitud("20240124");
		 c.setHoraSolicitud("10:10");
//		 c.setEsCitaAdicional("si");
//		 c.setServicio("");
//		 c.setMedico("aa") ;
//		 c.setIdTipoServicio(0);
//		 c.setIdTipoCondicionAlEstab(0);
//		 c.setIdTipoEdad(0)    ;
//		 c.setIdOrigenAtencion(0) ;
//		 c.setIdTipoCondicionAlServicio(0);
		 c.setIdProducto(0) ;
		 c.setIdTipoFinanciamiento(0);
		 c.setUsuario("ngeldres");
//		 c.setNumeroOperacion("");
//		 c.setNumeroTelefono("");
//		 c.setEntidadDestino("");
		 c.setPrecioUnitario(70);
		 c.setIdPuntoCarga(0);
		 c.setIdTipoFinanciamiento(0);
		 c.setIdFuenteFinanciamiento(0);
		 c.setIdUsuario(0) ;
				
		 citaController.crearCita(c, null);		 
