...
public class MedicacionResponseDTO {
    ...
    // id_medicacion integer (Clave Primaria, generada)
    ...
    public Integer getIdMedicacion() { return idMedicacion; }
    public void setIdMedicacion(Integer idMedicacion) { this.idMedicacion = idMedicacion; }
