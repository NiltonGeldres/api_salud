...
public class AtencionMedicaResponse {
    ...
    // 🟢 Inyección directa del JSON de PostgreSQL (sin cadenas escapadas ni re-serialización)
    @JsonRawValue
    ...
    // 🟢 Colección con los 4 documentos (historia, receta, orden, indicaciones)
    ...
    public AtencionMedicaResponse(boolean exito, String mensaje, Long idAtencion, 
                                  Integer idEstadoAtencion, String estadoFirma) {
        this.exito = exito;
    ...
    // Helper method para adjuntar cada uno de los 4 documentos de forma fluida
    public void agregarDocumento(DocumentoAdjuntoDTO doc) {
    ...
    public OffsetDateTime getTsProcesamiento() {
        return tsProcesamiento;
    }

    public void setTsProcesamiento(OffsetDateTime tsProcesamiento) {
        this.tsProcesamiento = tsProcesamiento;
    }
