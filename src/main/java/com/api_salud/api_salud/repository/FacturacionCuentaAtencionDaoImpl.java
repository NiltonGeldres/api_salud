...
/*			System.out.println("Inicio : Dao crearFacturacionCuentaAtencion ");
			System.out.println( "DATOS:  "+ facturacionCuentaAtencionEntity.getIdCuentaAtencion()
			+ facturacionCuentaAtencionEntity.getIdPaciente()+"--"
			+ facturacionCuentaAtencionEntity.getFechaApertura()+"--"
			+ facturacionCuentaAtencionEntity.getHoraApertura()+"--"
			+ facturacionCuentaAtencionEntity.getFechaCierre()+"--"
			+ facturacionCuentaAtencionEntity.getHoraCierre()+"--"
			+ facturacionCuentaAtencionEntity.getTotalExonerado()+"--"
			+ facturacionCuentaAtencionEntity.getTotalAsegurado()+"--"
			+ facturacionCuentaAtencionEntity.getTotalPagado()+"--"
			+ facturacionCuentaAtencionEntity.getIdEstado()+"--"
			+ facturacionCuentaAtencionEntity.getTotalPorPagar()+"--"
			+ facturacionCuentaAtencionEntity.getIdUsuarioCrea()+"--"
			+ facturacionCuentaAtencionEntity.getIdUsuarioModifica()+"--"
    		+ facturacionCuentaAtencionEntity.getFechaCreacion()+"--"
    		+ facturacionCuentaAtencionEntity.getFechaModificacion());			
*/			
			int  response = 20;
