...
public class FacturacionServicioDespachoDaoImpl  implements FacturacionServicioDespachoDao{
	...
	public int crearFacturacionServicioDespacho(FacturacionServicioDespachoEntity facturacionServicioDespachoEntity) {
        System.out.println("***Inicia DaoFacturacionServicioDespacho: crearFacturacionServicioDespacho "+facturacionServicioDespachoEntity.getIdProducto());            
        int response = 1;
        ...
        System.out.println("***Termina DaoFacturacionServicioDespacho: crearFacturacionServicioDespacho ");            
		return response;   
